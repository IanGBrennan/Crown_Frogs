library(ggplot2)
library(ggrepel)
source("/Users/ianbrennan/My Drive/R.Analyses/Convenient Scripts/ggplotRegression.R")

rad <- read.csv("/Users/ianbrennan/Documents/GitHub/Crown_Frogs/Comparative_Radiations.csv", h=T)
